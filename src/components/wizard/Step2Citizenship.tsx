  ...
  return (
    <div>
      ...
      <div className="space-y-5">
        ...
        <div>
          <label className="block text-sm font-semibold text-gray-700">
            Are you an active or honorably discharged veteran or spouse?
          </label>
          <YesNoButtons
          ...
          {client.isVeteran === "yes" && (
            <p className="mt-2 text-sm text-green-700 bg-green-50 border border-green-200 rounded-lg px-3 py-2">
              VA loan eligibility detected — strong new build candidate if targeting West Valley / Maricopa / Santan.
            </p>
          )}
        </div>
